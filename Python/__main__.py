...
if __name__=="__main__":
    try:
        ...
        banco=Conector_postgres("127.0.0.1","Atividade17","postgres","postgres",)
        
        escolha=input("Escolha o que você deseja fazer: \n1-Ler o CSV em um DF e inserir no BD \n2-insights")
        
        if escolha=="1":   
            print("Lendo o CSV em um DF")
            df=pd.read_csv("C:\\Users\\Yaporandy\\Desktop\\SOULCODE\\Atv17-PrimeiroETL\\data\\RefugiadosUcrania_Polonia.csv")
            ...
            while True:    
                ...
                if escolha2=="1":
                    ...
                    #Oitavo insight - Cidades utilizadas pelos refugiados
                    ...
                    eixox=[cidades_utilizadas[0][0],cidades_utilizadas[1][0],cidades_utilizadas[2][0],cidades_utilizadas[3][0],cidades_utilizadas[4][0],cidades_utilizadas[5][0],cidades_utilizadas[6][0],cidades_utilizadas[7][0],cidades_utilizadas[8][0],cidades_utilizadas[9][0],cidades_utilizadas[10][0]]
                    
                    eixoy=[cidades_utilizadas[0][1],cidades_utilizadas[1][1],cidades_utilizadas[2][1],cidades_utilizadas[3][1],cidades_utilizadas[4][1],cidades_utilizadas[5][1],cidades_utilizadas[6][1],cidades_utilizadas[7][1],cidades_utilizadas[8][1],cidades_utilizadas[9][1],cidades_utilizadas[10][1]]
                    
                    Grafico.plotBarra(eixox,eixoy,"blue","Cidades utilizadas pelos refugiados","Cidades","Qtde Refugiados")
